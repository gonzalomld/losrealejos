...
export const AREAS: Area[] = [
  ...
  { id: "omic", nombre: "OMIC (Oficina Municipal de Información a la Persona Consumidora)", descripcion: "Ayuda si tienes un problema con una compra o un servicio.", responsable: "Concejalía de Consumo", telefono: "922 34 62 50", correo: "omic@losrealejos.es", ubicacion: "Avenida de Canarias, 6", tramiteIds: ["instancia-generica"] },
