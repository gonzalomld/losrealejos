...
export default async function MapaDelSitio() {
  const [TRAMITES, AYUDAS, NOTICIAS, EVENTOS, SERVICIOS_BARRIO, AREAS]: [Tramite[], Ayuda[], Noticia[], Evento[], ServicioBarrio[], Area[]] = await Promise.all([
    leerParaFront<Tramite>("tramites"), leerParaFront<Ayuda>("ayudas"), leerParaFront<Noticia>("noticias"),
    leerParaFront<Evento>("eventos"), leerParaFront<ServicioBarrio>("servicios"), leerParaFront<Area>("areas"),
  ]);
  return (
